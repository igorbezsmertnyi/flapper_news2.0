...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__states_service__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__containers_ShowPost_showpost_container__ = __webpack_require__(105);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__components_LogOut_logout_componet__ = __webpack_require__(101);
...
], FirstStep.prototype, "status", void 0);
__decorate([
    ...
    function SecondStep(st, sr) {
        ...
        this.sr.secondStep.subscribe(function (val) {
            if (val) {
                ...
                _this.currentImage = val.source;
                _this.overlayValue = val.overlay.opacity;
                _this.color = val.overlay.color;
                _this.blurValue = val.overlay.blur;
                _this.grayValue = val.overlay.gray;
            }
        });
        this.st.postStatus.subscribe(function (val) {
            val ? _this.removePicture() : null;
        });
    }
                    ...
                    if (_this.imageData[0].type === type) {
                        ...
                        fileReader_1.onload = function () {
                            ...
                            if (fileReader_1.result) {
                                _this.sr.setSecondStepData(_this.emitSecondStep());
                            }
                        };
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Boolean)
], SecondStep.prototype, "status", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
    __metadata("design:type", Object)
...
var ThirdStep = (function () {
    function ThirdStep(postService, sr, st) {
        var _this = this;
        ...
        this.options = {
            ...
            events: {
                'froalaEditor.contentChanged': function (e, editor) {
                    ...
                    _this.sr.setThirdStepData(_this.content);
                },
                'froalaEditor.initialized': function (e, editor) {
                    ...
                    _this.st.postStatus.subscribe(function (val) {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Boolean)
], ThirdStep.prototype, "status", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Boolean)
...
var EditForm = (function () {
    function EditForm(localStorage, st, sr) {
        var _this = this;
        ...
        this.sr.thirdStep.subscribe(function (val) {
            if (val) {
                ...
                _this.isValid = false;
                _this.thirdStepIsValid = false;
            }
        });
        this.st.postStatus.subscribe(function (val) {
            val ? _this.clearForm() : null;
        });
    }
...
var StoreService = (function () {
    function StoreService() {
        ...
        this._firstStep = new __WEBPACK_IMPORTED_MODULE_1_rxjs__["Subject"]();
        this.firstStep = this._firstStep.asObservable();
        this._secondStep = new __WEBPACK_IMPORTED_MODULE_1_rxjs__["Subject"]();
        this.secondStep = this._secondStep.asObservable();
        this._thidStep = new __WEBPACK_IMPORTED_MODULE_1_rxjs__["Subject"]();
        this.thirdStep = this._thidStep.asObservable();
    }
    StoreService.prototype.setCurrentSession = function (data) {
        this._userSession.next(data);
    };
    StoreService.prototype.setFistStepData = function (data) {
        this._firstStep.next(data);
    };
    StoreService.prototype.setSecondStepData = function (data) {
        this._secondStep.next(data);
    };
    StoreService.prototype.setThirdStepData = function (data) {
...
// module
exports.push([module.i, "/* You can add global styles to this file, and also import other style files */\n#appContainer {\n  width: 100%;\n  padding: 0;\n  margin: 0;\n  overflow-x: hidden; }\n\na,\na:hover,\na:active,\na:visited,\na:focus {\n  color: #181819;\n  text-decoration: none; }\n\nh3 {\n  font-size: 18px;\n  font-weight: 700;\n  font-family: 'Roboto', sans-serif; }\n\nspan {\n  font-size: 14px;\n  font-family: 'Noto Sans', sans-serif; }\n\np {\n  font-size: 14px;\n  font-family: 'Noto Serif', serif; }\n\nlabel {\n  font-family: Roboto,\"Helvetica Neue\",sans-serif;\n  font-size: 14px;\n  margin-bottom: 7px; }\n\ninput {\n  height: 25px;\n  padding: 5px;\n  font-family: 'Noto Sans', sans-serif;\n  font-size: 14px;\n  outline: none;\n  border: 0;\n  border-bottom: 1px solid #BDC3C7;\n  color: #181819;\n  background-color: transparent; }\n\n.fixed {\n  overflow: hidden; }\n\n.up-btn {\n  width: 30px;\n  height: 30px;\n  background-image: url(\"/assets/images/plus.svg\");\n  background-size: contain;\n  background-position: center;\n  opacity: 0.4;\n  cursor: pointer;\n  transition: all ease-in-out 0.2s; }\n  .up-btn:hover {\n    opacity: 0.8;\n    transition: all ease-in-out 0.2s; }\n  .up-btn--active {\n    opacity: 1; }\n\n.dis-btn {\n  width: 30px;\n  height: 30px;\n  background-image: url(\"/assets/images/minus.svg\");\n  background-size: contain;\n  background-position: center;\n  opacity: 0.4;\n  cursor: pointer;\n  transition: all ease-in-out 0.2s; }\n  .dis-btn:hover {\n    opacity: 0.8;\n    transition: all ease-in-out 0.2s; }\n  .dis-btn--active {\n    opacity: 1; }\n\n.step-title p {\n  text-align: center;\n  margin-top: 25px;\n  font-size: 16px;\n  font-family: 'Noto Sans', sans-serif; }\n\n.dafault-label {\n  margin-bottom: 7px; }\n  .dafault-label label {\n    text-transform: uppercase;\n    color: #c0c0c0;\n    font-size: 14px;\n    font-weight: 300;\n    font-family: Roboto,\"Helvetica Neue\",sans-serif; }\n\ncolor-picker .color-picker {\n  border: 1px solid #c0c0c0 !important;\n  box-shadow: 9px 8px 16px -4px rgba(24, 24, 25, 0.11); }\n  color-picker .color-picker .cursor {\n    border: 2px solid #c0c0c0 !important; }\n  color-picker .color-picker .box .left .selected-color {\n    box-shadow: 9px 8px 16px -4px rgba(24, 24, 25, 0.11); }\n\n.fr-toolbar,\n.fr-wrapper {\n  box-shadow: none !important;\n  border: 1px solid #c0c0c0 !important; }\n\n.fr-box.fr-basic .fr-element {\n  min-height: 300px !important;\n  max-height: 300px !important; }\n\n.color-picker {\n  top: 45% !important;\n  left: 51% !important; }\n\nbody {\n  margin: 0 !important;\n  background: #fff; }\n\n.menu-container {\n  position: fixed;\n  width: 100px;\n  height: 98%;\n  top: 0;\n  padding: 8px;\n  background-color: #fff;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: justify;\n      -ms-flex-pack: justify;\n          justify-content: space-between;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n      -ms-flex-flow: column wrap;\n          flex-flow: column wrap;\n  box-shadow: 9px 8px 16px -4px rgba(24, 24, 25, 0.11); }\n  @media (max-width: 992px) {\n    .menu-container {\n      width: 100%;\n      height: 50px;\n      z-index: 100; } }\n  .menu-container__account-info {\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n        -ms-flex-direction: column;\n            flex-direction: column;\n    -webkit-box-pack: center;\n        -ms-flex-pack: center;\n            justify-content: center;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center; }\n    .menu-container__account-info__user-name {\n      text-align: center; }\n      .menu-container__account-info__user-name p {\n        color: #181819;\n        margin: 0 0 0 2px;\n        line-height: 1.3;\n        font-family: Helvetica, sans-serif; }\n    .menu-container__account-info__user-img {\n      width: 75px;\n      height: 75px;\n      margin-right: 10px;\n      border-radius: 100px;\n      overflow: hidden;\n      border-color: transparent;\n      margin-bottom: 15px;\n      box-shadow: 9px 8px 16px -4px rgba(24, 24, 25, 0.11); }\n      .menu-container__account-info__user-img img {\n        width: 100%;\n        height: 100%;\n        -o-object-fit: contain;\n           object-fit: contain;\n        -o-object-position: center;\n           object-position: center; }\n  .menu-container__user-menu {\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-pack: center;\n        -ms-flex-pack: center;\n            justify-content: center;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n        -ms-flex-flow: column nowrap;\n            flex-flow: column nowrap; }\n    .menu-container__user-menu div {\n      height: 30px;\n      margin-top: 25px; }\n    .menu-container__user-menu a {\n      cursor: pointer; }\n      .menu-container__user-menu a i {\n        font-size: 30px;\n        color: #BDC3C7;\n        transition: all ease-in-out 0.3s; }\n        .menu-container__user-menu a i:hover {\n          color: #869198;\n          transition: all ease-in-out 0.3s; }\n        .menu-container__user-menu a i:active {\n          color: #545e64; }\n  .menu-container__account-action {\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-pack: center;\n        -ms-flex-pack: center;\n            justify-content: center;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n        -ms-flex-flow: column nowrap;\n            flex-flow: column nowrap; }\n    .menu-container__account-action__log-in a, .menu-container__account-action__sign-up a {\n      font-family: Helvetica;\n      text-transform: uppercase;\n      font-size: 12px;\n      display: -webkit-box;\n      display: -ms-flexbox;\n      display: flex;\n      -webkit-box-align: center;\n          -ms-flex-align: center;\n              align-items: center;\n      -webkit-box-orient: horizontal;\n      -webkit-box-direction: normal;\n          -ms-flex-flow: row nowrap;\n              flex-flow: row nowrap; }\n      .menu-container__account-action__log-in a i, .menu-container__account-action__sign-up a i {\n        margin-right: 7px;\n        font-size: 20px; }\n    .menu-container__account-action__log-out i {\n      font-size: 38px; }\n    .menu-container__account-action a {\n      margin-top: 12px;\n      cursor: pointer;\n      color: #BDC3C7;\n      transition: all ease-in-out 0.3s; }\n      .menu-container__account-action a i {\n        color: #BDC3C7; }\n      .menu-container__account-action a:hover {\n        transition: all ease-in-out 0.3s;\n        color: #869198; }\n        .menu-container__account-action a:hover i {\n          color: #869198; }\n      .menu-container__account-action a:active {\n        color: #545e64; }\n        .menu-container__account-action a:active i {\n          color: #545e64; }\n\n.login-form {\n  position: fixed;\n  width: 350px;\n  height: 220px;\n  margin: auto;\n  padding: 15px;\n  left: 0;\n  top: 150%;\n  right: 0;\n  bottom: 0;\n  z-index: 9999;\n  background-color: #fff;\n  overflow: hidden;\n  border-radius: 7px;\n  transition: all ease-out .3s;\n  box-shadow: 9px 8px 16px -4px rgba(24, 24, 25, 0.11); }\n  .login-form__background {\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    background-color: #000;\n    opacity: 0.4;\n    left: 0;\n    top: 0;\n    z-index: 1; }\n  .login-form--active {\n    top: 0;\n    transition: all ease-in .3s; }\n", ""]);
